...
export const ALGORITHMS: Algorithm[] = [
  {
    ...
    category: "basic", icon: 0, accent: "#66e3ff", tagline: "となり同士を比べて、泡のように浮かせる。",
  ...
  },
  {
    ...
    category: "basic", icon: 1, accent: "#f6bf5b", tagline: "最小の一本を見つけて、先頭へ。",
  ...
  },
  {
    ...
    category: "basic", icon: 2, accent: "#8aa8ff", tagline: "一枚ずつ、正しいすき間へ差し込む。",
  ...
  },
  {
    ...
    category: "fast", icon: 3, accent: "#a78bfa", tagline: "分けて、整えて、ひとつに結ぶ。",
  ...
  },
  {
    ...
    category: "fast", icon: 4, accent: "#ff4fa3", tagline: "基準を決めて、一気に左右へ切り分ける。",
  ...
  },
  {
    ...
    category: "fast", icon: 5, accent: "#f3a53b", tagline: "山の頂点から、最大値を掘り出す。",
  ...
  },
  {
    ...
    category: "fast", icon: 6, accent: "#50e4d2", tagline: "遠くを先に整えて、すき間を縮める。",
  ...
  },
  {
    ...
    category: "linear", icon: 7, accent: "#79e36b", tagline: "比べずに数えて、順番を再構築。",
  ...
  },
  {
    ...
    category: "linear", icon: 8, accent: "#2d9cff", tagline: "一の位、十の位。桁ごとに整える。",
  ...
  },
  {
    ...
    category: "basic", icon: 9, accent: "#ff4fb5", tagline: "右へ、左へ。シェイクしながら往復。",
  ...
  },
  {
    ...
    category: "basic", icon: 10, accent: "#ff923d", tagline: "大きな櫛から、細かな櫛へ。",
  ...
  },
  {
    ...
    category: "unique", icon: 11, accent: "#e85b54", tagline: "順番が違ったら、一歩戻って直す。",
  ...
  },
  {
    ...
    category: "unique", icon: 12, accent: "#bc75ff", tagline: "奇数組と偶数組、交互に連携。",
  ...
  },
  {
    ...
    category: "unique", icon: 13, accent: "#b8f04a", tagline: "置き場所を見抜き、最小回数で回す。",
  ...
  },
  {
    ...
    category: "unique", icon: 14, accent: "#ffbd57", tagline: "先頭からまとめて、くるっと裏返す。",
  ...
  },
  {
    ...
    category: "linear", icon: 15, accent: "#53cfff", tagline: "近い値を同じバケツへ集める。",
  ...
  },
  {
    ...
    category: "fast", icon: 16, accent: "#d39a4e", tagline: "小さく整え、巧みに合奏させる。",
  ...
  },
  {
    ...
    category: "unique", icon: 17, accent: "#d7d8ff", tagline: "伸びる一本を抜き出し、編み合わせる。",
  ...
  },
  {
    ...
    category: "unique", icon: 18, accent: "#f06ad6", tagline: "三分の二を、三度もおさらい。",
  ...
  },
  {
    ...
    category: "fast", icon: 19, accent: "#6aa7ff", tagline: "速さを攻めて、深追いしたら守りへ。",
